...
<body>
      ...
      <div class="text-center">
        ...
        <?php if (isset($_SESSION['login'])) { ?>
          ...
          <?php if ($_SESSION['uloga'] == 'Administrator') { ?>
            <a class="btn btn-default btn-rounded my-3" href="pregled-narudzbi.php">Pregled narudžbi</a>
            <a class="btn btn-default btn-rounded my-3" href="upravljanje-korisnicima.php">Upravljanje korisnicima</a>
          <?php } ?>
  ...
  <div class="container2">
    <img
      src="https://img.freepik.com/premium-photo/american-fast-food-hamburgers-french-fries-hot-dogs-fast-food-unhealthy-eating-concept-top-view_114941-2408.jpg"
      style="object-fit: cover; width: 1500px; height: 900px;">
    <div class="left">
      <h1 style="font-size:7vw">Dobrodošli!</h1>
    </div>
  </div>
  <br>
  <br>
  ...
  <div class="container3">
    ...
    <div class="foodpic1"><img src="slike/hamb2.jpg"></div>
    <div class="foodpic1"><img src="slike/kebab2.jpg"></div>
    <div class="foodpic1"><img src="slike/pizza2.jpg"></div><br>
  </div><br><br><br>

  <div style="text-align: center;">
    <h1>Započnite svoju narudžbu odmah!<h1>
  </div>
  </div><br><br>
